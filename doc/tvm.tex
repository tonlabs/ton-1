...
\begin{abstract}
The aim of this text is to provide a description of the Telegram Open Network Virtual Machine (TON VM or TVM), used
to execute smart contracts in the TON Blockchain.
\end{abstract}
...
\item {\tt F912} --- {\tt GRTH16SS} ($s$ -- $s$), computes Groth16 proof of the data bits of a {\em Slice\/}~$s1$.
...
\item {\tt F913} --- {\tt GRTH16CS} ($c$ -- $s$), computes Groth16 proof of the data bits of a {\em Cell\/}~$c$.
